...
<body>
    <header>
        ...
        <h1>ADMIN - SWS-SENAI Web Service</h1>
        <nav>
            <ul>
                ...
                <li><a href="#">Consultas</a>
                    <ul>
                        <li><a href="consultas.php">Horário</a></li>
                        <li><a href="consultas.php">Instrutor</a></li>
                        <li><a href="consultas.php">Instrutor calendário</a></li>
                        <li><a href="consultas.php">Sala</a></li>
                        <li><a href="consultas.php">Sala calendário</a></li>
                    </ul>
                </li>
